...
<style>
    .thaydoi{color: #fff;background: #083f88;padding: 10px 20px;text-transform: uppercase}
    .wp_back_home{float: left;padding: 6px 10px;background: #008cd7 !important;color: #fff;line-height: inherit !important;margin-top: 130px!important;;margin-right: -130px!important;cursor: pointer}
</style>
