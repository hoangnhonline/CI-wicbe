            ...
            <?php foreach ($this->M_artice->show_list_lang() as $lang) { ?>
                <p class="div_lang <?php echo $lang->name ?>" >
                 ...
                 <?php echo form_error('name_' . $lang->name); ?> 
                    ...
                    <input name="link_<?=$lang->name?>"  type="text" id="textfield" value="" class="inputbox weight">
                 </p>
                 <?php } ?>
                    <p>
                    <label for="textfield"><strong>Thứ tự (Thứ tự càng lớn độ ưu tiên càng cao)</strong></label>
                    <input name="item_weight"  type="text" id="textfield" value="" class="inputbox weight">
                 </p>
