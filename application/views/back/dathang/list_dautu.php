...
<div class="contentcontainer">
    ...
    <div class="contentbox">
        ...
        <table id=dstin  border=1 cellpadding=1  cellspacing=0  width="100%"  align=center>
            <tr>
                <td  colspan="8"> <form  id="form2" name="form2" method="get" action="<?=  base_url('back/lienhe/dathang')?>" >
            ...
            <tr>
                ...
                <th width="150" > Email Liên hệ </span></th>
                <th width="120">Ngày Liên Hệ</th>
                <th style="text-align:center" width="100">Duyệt đơn hàng</th>
            ...
            <?php foreach ($list as $row){ ?>
                <tr class="hang">
                    ...
                    <td style="text-align: center" class="action">
                        <a href="<?=  base_url('back/lienhe/xemdautu/'.$row->id)?>">Xem</a>  |

                        <a href="<?=  base_url('back/lienhe/delete_dh/'.$row->id)?>" onclick="return confirm('Có chắc bạn muốn xóa ?');" >Xóa</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
