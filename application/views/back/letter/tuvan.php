    ...
    <div class="contentbox">
        ...
        <table id="dstin" border="1" cellpadding="1" cellspacing="0" width="100%" align=center>
            <tr>
                ...
                <th width="200" style="text-align:center">Phone</th>
                <th width="200" style="text-align:center">link</th>
            ...
            <?php foreach ($list as $e) { ?>
                <tr class="hang" style="background: #f5f5f5">
                    ...
                    <td class="tin" style="text-align:center"><?= $e->phone ?></td>
                    <td class="tin" style="text-align:center"><a href="<?= $e->link ?>" target="_blank"> view</a></td>
                    <td class="tin" style="text-align:center"><?= date('d-m-Y H:i:s',$e->time) ?></td>
                    <td align="center" style="text-align: center" class="action">
                        <a href="<?= site_url('back/email/delete1/'. $e->id) ?>" onclick="return confirm('Có chắc bạn muốn xóa ?');" >Xóa</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
