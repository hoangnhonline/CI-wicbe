    ...
    <div class="contentbox">
        ...
        <table id="dstin" border="1" cellpadding="1" cellspacing="0" width="100%" align=center>
            <tr>
                ...
                <th width="200" style="text-align:center">Ten</th>
                <th width="200" style="text-align:center">Noi dung</th>
            ...
            <?php foreach ($list as $e) { ?>
                <tr class="hang" style="background: #f5f5f5">
                    ...
                    <td class="tin" style="text-align:center"><?= $e->name ?></td>
                    <td class="tin" style="text-align:center"><?= $e->content ?></td>
