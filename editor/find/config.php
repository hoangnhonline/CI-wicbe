...
$baseUrl = str_replace('/editor/find/core/connector/php/connector.php?command=QuickUpload&type=Images&CKEditor=editor_vn&CKEditorFuncNum=1&langCode=en', '/',$baseUrl ); 
